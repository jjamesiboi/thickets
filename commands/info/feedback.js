...
module.exports = {
    ...
    if(!feedstr) return message.channel.send(`:x: u need to type how many stars and enter a message Example: .feedback 5 But the command .example command doesn't work :x:`)
